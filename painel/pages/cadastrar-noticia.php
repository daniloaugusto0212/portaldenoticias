<div class="box-content">
	...
	<form method="post" enctype="multipart/form-data">
			...
			if(isset($_POST['acao'])){
				...
				if($titulo == '' || $conteudo == ''){
					...
					if(Painel::imagemValida($capa)){
						...
						$arr = ['categoria_id'=>$categoria_id,'data'=>date('Y-m-d'),'titulo'=>$titulo, 'subtitulo' => $subtitulo, 'conteudo'=>$conteudo,'capa'=>$imagem,'slug'=>$slug,
						'order_id'=>'0',
		...
		<div class="form-group">
			...
			<textarea class="tinymce" name="subtitulo" value="<?php recoverPost('subtitulo'); ?>"></textarea>
		</div><!--form-group-->
